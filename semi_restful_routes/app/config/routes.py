...
routes['/show/<id>'] = 'Welcome#show'
routes['/edit/<id>'] = 'Welcome#edit'
routes['/delete/<id>'] = 'Welcome#delete'
routes['/add'] = 'Welcome#add'
routes['POST']['/process_edit/<id>'] = 'Welcome#process_edit'
routes['POST']['/process_add'] = 'Welcome#process_add'
"""
